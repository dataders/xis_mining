...
datatable(t1.report.ex, rownames = FALSE)
...
datatable(by_subject, caption = "T1-T2 Average Criteria Levels by Subject*", options = list(dom = 't'))
```
...
Now we the improvement metric for each class
